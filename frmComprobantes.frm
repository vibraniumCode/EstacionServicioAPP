...
Begin VB.Form frmComprobantes 
   ...
   Begin VB.Frame frmComprobante 
      ...
      Begin VB.CommandButton btnPrint 
         ...
         Height          =   855
         Left            =   6480
         Picture         =   "frmComprobantes.frx":145C
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   6240
         Width           =   1215
...
'    txtTicket2.SelText = txtTicket2.SelText + "                                                       Hora " + rs(10) + vbCrLf
    ...
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("Cód. 001", "00001-00000001") + vbCrLf
    'txtTicket2.SelBold = True
    txtTicket2.SelText = txtTicket2.SelText + "                     PETRORAFAELA  S R L" + vbCrLf
    'txtTicket2.SelBold = False
    txtTicket2.SelText = txtTicket2.SelText + "----------------------------------------------------------" + vbCrLf
...
'    txtTicket2.SelText = txtTicket2.SelText + CStr(rs(16)) + " x " + CStr(rs(18)) + "   (21)[83,88]                        " + CStr(rs(19)) + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68(CStr(rs(16)) + " x " + CStr(rs(18)) + "   (21)[83,88]", CStr(rs(19))) + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("Ajuste por redondeo       (21)", "0,00") + vbCrLf
...
'    txtTicket2.SelText = txtTicket2.SelText + "SUBTOT. IMP. NETO GRAVADO                  " + CStr(rs(19)) + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("SUBTOT. IMP. NETO GRAVADO", CStr(rs(19))) + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("ALICUOTA 21,00%", CStr(rs(23))) + vbCrLf
'    txtTicket2.SelText = txtTicket2.SelText + "ALICUOTA 21,00%                                         " + CStr(rs(23)) + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("10-Impuesto interno a nivel item", CStr(rs(22))) + vbCrLf
'    txtTicket2.SelText = txtTicket2.SelText + "10-Impuesto interno a nivel item         " + CStr(rs(22)) + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("07 - IDC", CStr(rs(21))) + vbCrLf
'    txtTicket2.SelText = txtTicket2.SelText + "07 - IDC                                                                  " + CStr(rs(21)) + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("IMPORTE TOTAL OTROS TRIBUTOS", CStr(rs(24))) + vbCrLf
'    txtTicket2.SelText = txtTicket2.SelText + "IMPORTE TOTAL OTROS TRIBUTOS         " + CStr(rs(24)) + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + vbCrLf
'    'txtTicket2.SelBold = True
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("TOTAL", CStr(rs(25))) + vbCrLf
...
rs.Open sql, conn, adOpenStatic, adLockReadOnly
    ...
    'txtTicket2.SelBold = True
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("Cantidad/Precio unit", "código") + vbCrLf
    'txtTicket2.SelBold = True
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("Descripción", "(%IVA) [%B.I.]  Precio Neto") + vbCrLf
    'txtTicket2.SelBold = False
    txtTicket2.SelText = txtTicket2.SelText + CStr(rs(15)) + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68(CStr(rs(16)) + " LS A " + CStr(rs(17)) + "(21)[90,95]", CStr(rs(19))) + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + vbCrLf
    'txtTicket2.SelBold = True
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("SUBTOTAL IMPORTE NETO NO GRAVADO", "0,00") + vbCrLf
    'txtTicket2.SelBold = True
    ...
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("Alicuota 21,00%", CStr(rs(23))) + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("IMPORTE TOTAL IVA", CStr(rs(23))) + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("10-Impuesto interno a nivel item", CStr(rs(22))) + vbCrLf
    'txtTicket2.SelBold = True
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("IMPORTE TOTAL OTROS TRIBUTOS", CStr(rs(22))) + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + vbCrLf
    'txtTicket2.SelBold = True
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("TOTAL", CStr(rs(25))) + vbCrLf
    'txtTicket2.SelBold = False
...
rs.Open sql, conn, adOpenStatic, adLockReadOnly
    ...
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("Valor ITC $" + CStr(rs(20)) + "  (21)[90,95]", CStr(rs(19))) + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("SUBTOT. IMP. NETO GRAVADO", CStr(rs(19))) + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("ALICUOTA 21,00%", CStr(rs(23))) + vbCrLf
    ...
    txtTicket2.SelText = txtTicket2.SelText + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + "RECIBI/MOS" + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("Efectivo", CStr(rs(25))) + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("Suma de sus pagos", CStr(rs(25))) + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("Su vuelto", "0,00") + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + vbCrLf
    txtTicket2.SelItalic = True
    txtTicket2.SelText = txtTicket2.SelText + "CF" + vbCrLf
    txtTicket2.SelItalic = False
...
rs.Open sql, conn, adOpenStatic, adLockReadOnly
    ...
    txtTicket2.SelText = txtTicket2.SelText + UCase(rs(15)) + vbCrLf
    'txtTicket2.SelBold = True
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68(CStr(rs(16)) + " x " + CStr(rs(17)), CStr(rs(19))) + vbCrLf
    'txtTicket2.SelBold = False
    txtTicket2.SelText = txtTicket2.SelText + "ITC: " + CStr(rs(20)) + vbCrLf
    'txtTicket2.SelBold = True
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("SUBTOTAL SIN DESCUENTO", CStr(rs(19))) + vbCrLf
    'txtTicket2.SelBold = False
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("TOTAL DESCUENTOS", "0,00") + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("TOTAL NETO SIN IVA", CStr(rs(19))) + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("SUBTOTAL 21.00 %", CStr(rs(19))) + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("IVA 21,00 %", CStr(rs(23))) + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("CONCEPTOS NO GRAVADOS", CStr(rs(24))) + vbCrLf
    'txtTicket2.SelBold = True
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("TOTAL", CStr(rs(25))) + vbCrLf
    'txtTicket2.SelBold = False
    txtTicket2.SelText = txtTicket2.SelText + vbCrLf
    ...
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("Imp. Líq. Carb.", CStr(rs(26))) + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("Imp. Comb. Liq.", CStr(rs(27))) + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + "OTROS IMPUESTOS" + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("IVA Matanza Variable 1.5%", CStr(rs(28))) + vbCrLf
    ...
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("Su vuelto", "0,00") + vbCrLf
    'txtTicket2.SelBold = False
    txtTicket2.SelText = txtTicket2.SelText + FormatearLinea68("Cantidad Unidades", "1") + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + vbCrLf
    txtTicket2.SelText = txtTicket2.SelText + "-------------------------------------------------" + vbCrLf
...
Function FormatearLinea68(ByVal concepto As String, ByVal importe As String) As String
    ...
    ' Asegurarse de que el número esté alineado a la derecha
    Dim textoIzq As String
    Dim textoDer As String
    
    textoIzq = Trim(concepto)
    textoDer = Trim(importe)
    
    ' Calcular cuántos espacios hay entre el texto y el importe
    Dim cantidadEspacios As Integer
    cantidadEspacios = totalLength - Len(textoIzq) - Len(textoDer)
    
    If cantidadEspacios < 0 Then
        ' Si es negativo, recortamos el concepto
        textoIzq = Left(textoIzq, totalLength - Len(textoDer) - 1)
        cantidadEspacios = 1
    End If
    
    espacios = Space(cantidadEspacios)
    textoFinal = textoIzq & espacios & textoDer
